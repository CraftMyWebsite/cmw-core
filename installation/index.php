...
<head>
    ...
    <link rel="icon" type="image/png"
          href="<?= getenv("PATH_SUBFOLDER") ?>admin/resources/images/identity/logo_compact.png">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <div class="row mb-3 justify-content-center">
                    <div class="col-3">
                        <a href="./?lang=fr"><img src="../admin/resources/vendors/flag-icon-css/flags/fr.svg"
                                                  class="flag-icon" alt="Passer le site en Français"></a>
                    </div>
                    <div class="col-3">
                        <a href="./?lang=en"><img src="../admin/resources/vendors/flag-icon-css/flags/gb.svg"
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= getenv("PATH_SUBFOLDER") ?>/cmw-admin">CraftMyWebsite</a>
                            </li>
            ...
            <div class="row">
                <div class="col-7">
                    <?php if ((isset($_GET['finish_step']) && $_GET['step'] == 4) || !file_exists("../.env") || getenv("STATUS") == 0) : ?>
                            ...
                            <div class="card">
                                ...
                                <form action="controller.php" role="form" method="post">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="submit" name="update_env"
                        ...
                        <?php if (isset($_GET['step']) && $_GET['step'] == 4) : ?>
                            <div class="card">
                                ...
                                <form action="controller.php" role="form" method="post">
                                    ...
                                    <!-- /.card-body -->
                                    <div class="card-footer">
                                        <button type="submit" name="website_config"
                                                class="btn btn-primary"><?= INSTALL_SAVE ?>
                                        </button>
                                    </div>
                                </form>
                        ...
                        <?php if (isset($_GET['step'], $_GET['finish_step']) && $_GET['step'] == 5) : ?>
                            <div class="card">
                                <div class="card-header">
