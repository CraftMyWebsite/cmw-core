...
<div class="d-flex flex-wrap justify-content-between">
    <h3>
        ...
        <span class="m-lg-auto">
            <?= LangManager::translate("core.Package.my_packages") ?>
        </span>
    </h3>
</div>
...
<section class="row">
    <div class="row">
        ...
        <?php foreach (PackageController::getLocalPackages() as $packages): ?>
            <div class="col-12 col-lg-6 mb-4">
                <div class="card" style="overflow: hidden;">
                    ...
                    <div class="position-absolute"
                        ...
                        <div class="alert-light-warning color-warning text-center px-5" style="opacity: .85">
            ...
            <!--Details modal -->
            <div class="modal fade text-left w-100" id="modal-<?= $packages->name() ?>" tabindex="-1"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">
                                <?= LangManager::translate("core.Package.close") ?>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <?php if (PackageController::isInstalled($packages['name'])): ?>
                ...
                <div class="col-12 col-lg-6 mb-4">
                    <div class="card" style="overflow: hidden;">
                        <div class="d-flex card-body">
                            <img class="rounded-3" style="height: 140px; width: 140px;"
                                 src="<?= $packages["icon"] ?>" alt="Image <?= $packages['name'] ?>">
                            ...
                            <div class="d-flex justify-content-between px-2 py-2 w-100">
                                <div>
                                    ...
                                    <small class="align-items-end">
                                        <?= LangManager::translate("core.Package.author") ?> <?= $packages['author_pseudo'] ?>
                                    </small>
                                </div>
                                <div>
