...
<div class="d-flex flex-wrap justify-content-between">
    <h3><i class="fa-solid fa-shop"></i> <span class="m-lg-auto"><?= LangManager::translate("core.Theme.config.title") ?></span></h3>
</div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="d-flex justify-content-end mt-auto gap-3">
                                                    <a href="manage" class="btn btn-sm btn-primary"><?= LangManager::translate("core.Theme.configure") ?></a>
                                                    <a href="install/<?= $theme['id'] ?>" class="btn btn-sm btn-danger"><?= LangManager::translate("core.Theme.reinstall") ?></a>
                                                   <form action="market/regenerate" method="post">
                                                        <?php (new SecurityManager())->insertHiddenToken() ?>
                                                        <div class="button">
                                    ...
                                    <div class="d-flex justify-content-center px-2 py-1">
                                        <form action="" method="post">
                                            ...
                                            <input hidden type="text" name="theme"value="<?= $theme->getName() ?>">
                                                <button type="submit" class="btn btn-sm btn-success"><?= LangManager::translate("core.Theme.activate") ?></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="d-flex justify-content-end mt-auto gap-3">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <input hidden type="text" name="theme"
                                                               value="<?= $theme['name'] ?>">
                                                        <button type="submit" class="btn btn-sm btn-success"><?= LangManager::translate("core.Theme.activate") ?>
                                                        </button>
                                                    </form>
                                                </div>
                                            </div>
...
<div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="confirmModalTitle"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmModalTitle"><?= LangManager::translate("core.Theme.verification") ?></h5>
