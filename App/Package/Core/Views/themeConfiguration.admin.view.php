                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-2">
                                            <h4 class="card-title"><?= $theme->getName() ?></h4>
                                        </div>
                                        <p>
                                            Version CMW recommandée : <?= $theme->getCmwVersion() ?><br>
                                            Version du thème : <?= $theme->getVersion() ?>
                                        </p>
                                        <div class="d-flex justify-content-between">
                                            <p><a href="" target="_blank"><i
                                                            class='fa-solid fa-at'></i><i> <?= $theme->getAuthor() ?? $theme->getAuthorsFormatted() ?></i></a>
                                            </p>
                                        </div>
                                    ...
                                    <div class="bg-info text-white text-center rounded-3 rounded-top py-1">
                                        <b>Thème actif</b>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-in-card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <img style="height: 170px; width: 100%; margin-bottom: 4px;"
                                                     src="<?= PublicAPI::getUrl() . '/' . $theme["icon"] ?>"
                                                     alt="Card image cap">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <p><a href="" target="_blank"><i
                                                                    class='fa-solid fa-at'></i><i> <?= $theme['author_pseudo'] ?></i></a>
                                                    </p>
                                                    <p><a href="<?= $theme['code_link'] ?>" target="_blank"><i
                                                                    class="fa-brands fa-github"></i></a></p>
                                                    <p><i class="fa-solid fa-download"></i> <?= $theme['downloads'] ?>
                                                    </p>
                                                </div>
                                                <div class="d-flex justify-content-around">
                                                    <a href="manage" class="btn btn-sm btn-primary">
                                                ...
                                                <div class="d-flex justify-content-around">
                                                    <a href="install/<?= $theme['id'] ?>"
                                                       class="btn btn-sm btn-primary"><i
                                                                class="fa-solid fa-download"></i> Installer</a>
                                                </div>
                                            </div>
                                        </div>
