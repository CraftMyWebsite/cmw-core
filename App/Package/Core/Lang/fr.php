...
Mettre à jour régulièrement votre CMS permet de garantir un environnement fiable, sécurisé et conforme aux évolutions techniques.',
    ...
    'fileManager' => [
        ...
        'error' => [
            'fileDefinition' => 'Cette extension n\'est pas prise en charge !',
            'folderDontExist' => 'Dossier cible introuvable',
            'emptyFile' => 'Aucune fichier envoyé !',
            'tooLarge' => 'Fichier trop volumineux !',
            'notAllowed' => 'Type de document non autorisé !',
            'move' => 'Impossible de déplacer le fichier.',
            'download' => 'Impossible télécharger le fichier.',
            'createFolder' => 'Impossible de créer le dossier cible, problème de permission sur Public/Uploads',
            'target' => 'La destination du fichier n\'est pas autorisé !',
            'secure' => 'https obligatoire !',
            'notFound' => 'Fichier introuvable !',
            'cantOpen' => 'Impossible d\'ouvrir le fichier !',
            'zipNotFound' => 'Cible Zip non trouvé !',
            'deleteFile' => 'Impossible de supprimer le fichier !',
        ],
    ],
    'imageDropper' => [
