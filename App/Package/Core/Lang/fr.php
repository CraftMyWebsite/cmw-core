...
Mettre à jour régulièrement votre CMS permet de garantir un environnement fiable, sécurisé et conforme aux évolutions techniques.',
    ...
    "updates" => [
        ...
        'success' => 'Mise à jour de votre site vers la version %version% réussie',
    ],
    'security' => [
        'title' => 'Sécurité',
    ...
    'imageManager' => [
        'converter' => [
            'ERROR_SAVING_FILE' => 'Erreur lors de la sauvegarde de l\'image.',
            'ERROR_INVALID_TARGET_FORMAT' => 'Format cible invalide. Original conservé !',
            'ERROR_UNSUPPORTED_CONVERSION_FORMAT' => 'Format de conversion non supporté, Original conservé !',
            'ERROR_CONVERTING_IMAGE' => 'Erreur lors de la conversion de l\'image. Original conservé !',
        ],
        'error' => [
            'ERROR_INVALID_FILE_DEFINITION' => 'Cette extension n\'est pas prise en charge !',
            'ERROR_FOLDER_DONT_EXIST' => 'Dossier cible introuvable',
            'ERROR_EMPTY_FILE' => 'Aucune image envoyé !',
            'ERROR_FILE_TOO_LARGE' => 'Image trop volumineuse !',
            'ERROR_FILE_NOT_ALLOWED' => 'Type de document non autorisé !',
            'ERROR_CANT_MOVE_FILE' => 'Impossible de déplacer l\'image.',
            'ERROR_CANT_DOWNLOAD_FILE' => 'Impossible télécharger l\'image.',
            'ERROR_CANT_CREATE_FOLDER' => 'Impossible de créer le dossier cible, problème de permission sur Public/Uploads',
        ],
    ],
    'fileManager' => [
        'title' => 'Fichiers',
        'error' => [
            'ERROR_INVALID_FILE_DEFINITION' => 'Cette extension n\'est pas prise en charge !',
            'ERROR_FOLDER_DONT_EXIST' => 'Dossier cible introuvable',
            'ERROR_EMPTY_FILE' => 'Aucune fichier envoyé !',
            'ERROR_FILE_TOO_LARGE' => 'Fichier trop volumineux !',
            'ERROR_FILE_NOT_ALLOWED' => 'Type de document non autorisé !',
            'ERROR_CANT_MOVE_FILE' => 'Impossible de déplacer le fichier.',
            'ERROR_CANT_DOWNLOAD_FILE' => 'Impossible télécharger le fichier.',
            'ERROR_CANT_CREATE_FOLDER' => 'Impossible de créer le dossier cible, problème de permission sur Public/Uploads',
            'ERROR_INVALID_FILE_TARGET' => 'La destination du fichier n\'est pas autorisé !',
            'ERROR_INVALID_SECURE' => 'https obligatoire !',
            'ERROR_FILE_NOT_FOUND' => 'Fichier introuvable !',
            'ERROR_CANT_OPEN_FILE' => 'Impossible d\'ouvrir le fichier !',
            'ERROR_ZIP_NOT_FOUND' => 'Cible Zip non trouvé !',
            'ERROR_CANT_DELETE_FILE' => 'Impossible de supprimer le fichier !',
        ],
    ],
    'imageDropper' => [
