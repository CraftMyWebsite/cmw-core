...
Keeping your CMS up to date ensures a reliable, secure, and future-proof environment.',
    ...
    'updates' => [
        ...
        'success' => 'Website update with success to %version%',
    ],
    'security' => [
        'title' => 'Security',
    ...
    'imageManager' => [
        'converter' => [
            'ERROR_SAVING_FILE' => 'Error saving image.',
            'ERROR_INVALID_TARGET_FORMAT' => 'Invalid target format. Original kept!',
            'ERROR_UNSUPPORTED_CONVERSION_FORMAT' => 'Conversion format not supported, Original kept!',
            'ERROR_CONVERTING_IMAGE' => 'Error converting image. Original kept!',
        ],
        'error' => [
            'ERROR_INVALID_FILE_DEFINITION' => 'This extension is not supported!',
            'ERROR_FOLDER_DONT_EXIST' => 'Target folder not found',
            'ERROR_EMPTY_FILE' => 'No image sent!',
            'ERROR_FILE_TOO_LARGE' => 'Image too big!',
            'ERROR_FILE_NOT_ALLOWED' => 'Document type not allowed!',
            'ERROR_CANT_MOVE_FILE' => 'Unable to move image.',
            'ERROR_CANT_DOWNLOAD_FILE' => 'Unable to download image.',
            'ERROR_CANT_CREATE_FOLDER' => 'Unable to create target folder, permission problem on Public/Uploads',
        ],
    ],
    'fileManager' => [
        'title' => 'Files',
        'error' => [
            'ERROR_INVALID_FILE_DEFINITION' => 'This extension is not supported!',
            'ERROR_FOLDER_DONT_EXIST' => 'Target folder not found',
            'ERROR_EMPTY_FILE' => 'No file uploaded!',
            'ERROR_FILE_TOO_LARGE' => 'File is too large!',
            'ERROR_FILE_NOT_ALLOWED' => 'Document type not allowed!',
            'ERROR_CANT_MOVE_FILE' => 'Unable to move the file.',
            'ERROR_CANT_DOWNLOAD_FILE' => 'Unable to download the file.',
            'ERROR_CANT_CREATE_FOLDER' => 'Unable to create the target folder, permission issue on Public/Uploads',
            'ERROR_INVALID_FILE_TARGET' => 'File destination is not allowed!',
            'ERROR_INVALID_SECURE' => 'HTTPS required!',
            'ERROR_FILE_NOT_FOUND' => 'File not found !',
            'ERROR_CANT_OPEN_FILE' => 'Unable to open this file!',
            'ERROR_ZIP_NOT_FOUND' => 'Target Zip not found !',
            'ERROR_CANT_DELETE_FILE' => 'Unable te remove file!',
        ],
    ],
    'imageDropper' => [
