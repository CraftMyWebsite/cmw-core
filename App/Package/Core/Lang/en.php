...
Keeping your CMS up to date ensures a reliable, secure, and future-proof environment.',
    ...
    'fileManager' => [
        ...
        'error' => [
            'fileDefinition' => 'This extension is not supported!',
            'folderDontExist' => 'Target folder not found',
            'emptyFile' => 'No file uploaded!',
            'tooLarge' => 'File is too large!',
            'notAllowed' => 'Document type not allowed!',
            'move' => 'Unable to move the file.',
            'download' => 'Unable to download the file.',
            'createFolder' => 'Unable to create the target folder, permission issue on Public/Uploads',
            'target' => 'File destination is not allowed!',
            'secure' => 'HTTPS required!',
            'notFound' => 'File not found !',
            'cantOpen' => 'Unable to open this file!',
            'zipNotFound' => 'Target Zip not found !',
            'deleteFile' => 'Unable te remove file!',
        ],
    ],
    'imageDropper' => [
