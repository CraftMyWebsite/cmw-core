...
return [
    ...
    "toaster" => [
        ...
        "user_delete_nop" => "Impossible de supprimer ce compte pour le moment",
        "user_delete_admin" => "Vous êtes l'administrateur du site !",
        "user_delete_is_admin" => "Ce compte est administrateur",
