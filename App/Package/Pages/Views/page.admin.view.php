...
<div class="d-flex flex-wrap justify-content-between">
    <h3><i class="fa-solid fa-file-lines"></i> <span
            class="m-lg-auto"><?= LangManager::translate("pages.list.sub_title") ?></span></h3>
</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table" id="table1">
                ...
                foreach ($pagesList as $page) : ?>
                    <tr>
                        <td><?= $page->getTitle() ?></td>
                        <td>
                            <a href="<?= Website::getProtocol() . '://' . $_SERVER['SERVER_NAME'] . EnvManager::getInstance()->getValue("PATH_SUBFOLDER") . "p/" . $page->getSlug() ?>"
                               target="_blank"><?= Website::getProtocol() . '://' . $_SERVER['SERVER_NAME'] . EnvManager::getInstance()->getValue("PATH_SUBFOLDER") . "p/" . $page->getSlug() ?></a>
                        </td>
                        ...
                        <td>
                            ...
                            <a class="me-3" href="pages/build/<?= $page->getId() ?>">
                                <i class="text-success fa-solid fa-person-digging"></i>
                            </a>
                            <a type="button" data-bs-toggle="modal" data-bs-target="#delete-<?= $page->getId() ?>">
                                <i class="text-danger fas fa-trash-alt"></i>
                            </a>
                            <div class="modal fade text-left" id="delete-<?= $page->getId() ?>" tabindex="-1"
                                 role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-danger">
                                            <h5 class="modal-title white"
                                                id="myModalLabel160"><?= LangManager::translate("pages.delete.button") ?> <?= $page->getTitle() ?>
                                                ?</h5>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="pages/delete/<?= $page->getId() ?>" class="btn btn-danger">
                                                <span
                                                    class=""><?= LangManager::translate("pages.delete.button") ?></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="button text-end">
                <a type="button" data-bs-toggle="modal" data-bs-target="#create" class="btn btn-primary">
        ...
        <form action="pages/add" method="post">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title white" id="myModalLabel160">Nouvelle page</h5>
                </div>
                <div class="modal-body text-left">
                    <h6>Nom de la page :</h6>
