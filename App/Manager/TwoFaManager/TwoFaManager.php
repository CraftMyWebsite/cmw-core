...
class TwoFaManager
{
    ...
    {
        require_once EnvManager::getInstance()->getValue('DIR') . 'App/Manager/TwoFaManager/Vendors/twofactorauth/lib/TwoFactorAuth.php';
        require_once EnvManager::getInstance()->getValue('DIR') . 'App/Manager/TwoFaManager/Vendors/twofactorauth/lib/Algorithm.php';
        require_once EnvManager::getInstance()->getValue('DIR') . 'App/Manager/TwoFaManager/Vendors/twofactorauth/lib/TwoFactorAuthException.php';

        require_once EnvManager::getInstance()->getValue('DIR') . 'App/Manager/TwoFaManager/Vendors/twofactorauth/lib/Providers/Rng/IRNGProvider.php';
