    ...
    <div class="container px-4 px-lg-5 h-100">
        <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-lg-8 align-self-baseline">
                ...
                <a class="btn btn-primary btn-xl" target="_blank" href="<?= EnvManager::getInstance()->getValue('PATH_SUBFOLDER') ?>cmw-admin">Panel d'administration</a>
                <?php else: ?>
                <a class="btn btn-primary btn-xl" href="<?= EnvManager::getInstance()->getValue('PATH_SUBFOLDER') ?>login">Connexion</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
