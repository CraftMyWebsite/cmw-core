...
<section class="page-section">
    ...
    <?php foreach ($newsList as $news): ?>
        ...
        <div class="text-center"><img style="max-width: 200px" src="<?= $news->getImageLink() ?>" alt="..."/></div>
            <h3 class="text-center"><a href="<?= EnvManager::getInstance()->getValue("PATH_SUBFOLDER") ?>news/<?= $news->getSlug() ?>"><?= $news->getTitle() ?></a></h3>
